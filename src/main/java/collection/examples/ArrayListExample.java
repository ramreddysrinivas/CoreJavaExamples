...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		...
		List<String> list =arrayListExample.prepareList(5);
	...
	private void iterateListWithListIterator(List<String> list) {
		...
		System.out.println("forward direction");
	      while(litr.hasNext()) { //it executes till the control reaches last element
	         String element = litr.next();
	        System.out.print(element + "+"); //element0+element1+element2+element3+element4+
	         
	      }
	      System.out.println("backward direction");
	      while(litr.hasPrevious()) { // in the above while loop control will be at the end of list. 
	    	  //if we iterate, it executes from last element to first.
	    	//it executes till the control reaches first element
		         Object element = litr.previous();
		         System.out.print(element + " "); //element4 element3 element2 element1 element0 
		      }
